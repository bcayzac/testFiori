jQuery.sap.declare("TestPrj2.Component");
jQuery.sap.require("sap.m.routing.RouteMatchedHandler");

sap.ui.core.UIComponent.extend("TestPrj2.Component", {
	metadata : {
		...
		routing: {
			config: {
				viewType : "XML",
				viewPath: "TestPrj2.view",  // common prefix
	...
	init : function() {
		...
		var rootPath = jQuery.sap.getModulePath("TestPrj2");
